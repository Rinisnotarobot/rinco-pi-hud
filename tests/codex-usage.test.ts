...
import { formatCodexUsageStatusline } from "../extensions/hud/telemetry/codex-usage/format.ts";
import { normalizeBackendPayload } from "../extensions/hud/telemetry/codex-usage/normalize.ts";
import { sanitizeCodexText } from "../extensions/hud/telemetry/codex-usage/safety.ts";
		...
		additional_rate_limits: [
			{
				...
				rate_limit: {
					...
					secondary_window: { used_percent: 20, limit_window_seconds: 604_800 } as
						{ used_percent: number; limit_window_seconds: number } | undefined,
				},
			},
		],
